...
const Login = () => {
	...
	const handleSubmit = (e) => {
		...
		dispatch(loginUser({ formData: formData, notify })).then(() => setIsFetchingApi(false));
	};
						...
						<div className="col-lg-7 mx-auto">
							<div className="card card-item">
								<div className="card-body">
									...
									<form method="post" className="pt-4" onSubmit={handleSubmit}>
										...
										<div className="btn-box" style={{ textAlign: "center" }}>
											<div className="d-flex align-items-center justify-content-between pb-4">
												<div className="custom-control custom-checkbox fs-15">
													{/* <input
														...
														required=""
													/>
													<label className="custom-control-label custom--control-label" htmlFor="rememberMeCheckbox">
														Remember Me
													</label> */}
												</div>
											...
											<button className="btn theme-btn mt-2">
												Login Account <i className="la la-arrow-right icon ml-1" />
											</button>
